...
import ch.fhnw.bacnetit.binding.ws.outgoing.tls.WSSConnectionClientFactory;
...
import ch.fhnw.bacnetit.lib.service.confirmed.AcknowledgeAlarmRequest;
import ch.fhnw.bacnetit.lib.service.confirmed.ConfirmedCovNotificationRequest;
import ch.fhnw.bacnetit.lib.service.confirmed.ConfirmedEventNotificationRequest;
import ch.fhnw.bacnetit.lib.service.confirmed.LifeSafetyOperationRequest;
import ch.fhnw.bacnetit.lib.service.confirmed.ReadPropertyRequest;
import ch.fhnw.bacnetit.lib.service.confirmed.SubscribeCOVPropertyRequest;
import ch.fhnw.bacnetit.lib.service.confirmed.SubscribeCOVRequest;
...
import ch.fhnw.bacnetit.stack.application.transaction.TransactionKey;
import ch.fhnw.bacnetit.stack.application.transaction.TransactionManagerListener;
import ch.fhnw.bacnetit.stack.application.transaction.TransactionState;
...
public class TestLocalSpecService {
    ...
    private void setupDiscovery() {
        ds = new DiscoveryConfig(DirectoryBindingType.DNSSD.name(),
