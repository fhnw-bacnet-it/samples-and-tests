...
public class EngineeringUnits extends Enumerated {
    ...
    // Acceleration
    public static final EngineeringUnits metersPerSecondPerSecond = new EngineeringUnits(
            166);

    // Area
    public static final EngineeringUnits squareMeters = new EngineeringUnits(0);

    public static final EngineeringUnits squareCentimeters = new EngineeringUnits(
            116);

    public static final EngineeringUnits squareFeet = new EngineeringUnits(1);

    public static final EngineeringUnits squareInches = new EngineeringUnits(
            115);
    ...
    public static final EngineeringUnits amperesPerMeter = new EngineeringUnits(
            167);

    public static final EngineeringUnits amperesPerSquareMeter = new EngineeringUnits(
            168);

    public static final EngineeringUnits ampereSquareMeters = new EngineeringUnits(
            169);
    ...
    public static final EngineeringUnits siemens = new EngineeringUnits(173); // 1
                                                                              // mho
                                                                              // equals
                                                                              // 1
                                                                              // siemens

    public static final EngineeringUnits siemensPerMeter = new EngineeringUnits(
            174);
    ...
    public static final EngineeringUnits kilovoltAmperes = new EngineeringUnits(
            9);

    public static final EngineeringUnits megavoltAmperes = new EngineeringUnits(
            10);

    public static final EngineeringUnits voltAmperesReactive = new EngineeringUnits(
            11);

    public static final EngineeringUnits kilovoltAmperesReactive = new EngineeringUnits(
            12);

    public static final EngineeringUnits megavoltAmperesReactive = new EngineeringUnits(
            13);

    public static final EngineeringUnits voltsPerDegreeKelvin = new EngineeringUnits(
            176);

    public static final EngineeringUnits voltsPerMeter = new EngineeringUnits(
            177);

    public static final EngineeringUnits degreesPhase = new EngineeringUnits(
            14);
    ...
    public static final EngineeringUnits kilojoulesPerKilogram = new EngineeringUnits(
            125);
    ...
    public static final EngineeringUnits kilowattHours = new EngineeringUnits(
            19);

    public static final EngineeringUnits megawattHours = new EngineeringUnits(
            146);
    ...
    // Enthalpy
    public static final EngineeringUnits joulesPerKilogramDryAir = new EngineeringUnits(
            23);

    public static final EngineeringUnits kilojoulesPerKilogramDryAir = new EngineeringUnits(
            149);

    public static final EngineeringUnits megajoulesPerKilogramDryAir = new EngineeringUnits(
            150);

    public static final EngineeringUnits btusPerPoundDryAir = new EngineeringUnits(
            24);

    public static final EngineeringUnits btusPerPound = new EngineeringUnits(
            117);

    // Entropy
    public static final EngineeringUnits joulesPerDegreeKelvin = new EngineeringUnits(
            127);

    public static final EngineeringUnits kilojoulesPerDegreeKelvin = new EngineeringUnits(
            151);

    public static final EngineeringUnits megajoulesPerDegreeKelvin = new EngineeringUnits(
            152);

    public static final EngineeringUnits joulesPerKilogramDegreeKelvin = new EngineeringUnits(
            128);
    ...
    // Frequency
    public static final EngineeringUnits cyclesPerHour = new EngineeringUnits(
            25);

    public static final EngineeringUnits cyclesPerMinute = new EngineeringUnits(
            26);
    ...
    // Humidity
    public static final EngineeringUnits gramsOfWaterPerKilogramDryAir = new EngineeringUnits(
            28);

    public static final EngineeringUnits percentRelativeHumidity = new EngineeringUnits(
            29);

    // Length
    public static final EngineeringUnits millimeters = new EngineeringUnits(30);

    public static final EngineeringUnits centimeters = new EngineeringUnits(
            118);
    ...
    public static final EngineeringUnits candelasPerSquareMeter = new EngineeringUnits(
            180);

    public static final EngineeringUnits wattsPerSquareFoot = new EngineeringUnits(
            34);

    public static final EngineeringUnits wattsPerSquareMeter = new EngineeringUnits(
            35);
    ...
    // Mass Flow
    public static final EngineeringUnits gramsPerSecond = new EngineeringUnits(
            154);

    public static final EngineeringUnits gramsPerMinute = new EngineeringUnits(
            155);

    public static final EngineeringUnits kilogramsPerSecond = new EngineeringUnits(
            42);

    public static final EngineeringUnits kilogramsPerMinute = new EngineeringUnits(
            43);

    public static final EngineeringUnits kilogramsPerHour = new EngineeringUnits(
            44);

    public static final EngineeringUnits poundsMassPerSecond = new EngineeringUnits(
            119);

    public static final EngineeringUnits poundsMassPerMinute = new EngineeringUnits(
            45);

    public static final EngineeringUnits poundsMassPerHour = new EngineeringUnits(
            46);

    public static final EngineeringUnits tonsPerHour = new EngineeringUnits(
            156);
    ...
    public static final EngineeringUnits kiloBtusPerHour = new EngineeringUnits(
            157);

    public static final EngineeringUnits horsepower = new EngineeringUnits(51);

    public static final EngineeringUnits tonsRefrigeration = new EngineeringUnits(
            52);

    // Pressure
    public static final EngineeringUnits pascals = new EngineeringUnits(53);

    public static final EngineeringUnits hectopascals = new EngineeringUnits(
            133);
    ...
    public static final EngineeringUnits poundsForcePerSquareInch = new EngineeringUnits(
            56);

    public static final EngineeringUnits centimetersOfWater = new EngineeringUnits(
            57);

    public static final EngineeringUnits inchesOfWater = new EngineeringUnits(
            58);

    public static final EngineeringUnits millimetersOfMercury = new EngineeringUnits(
            59);

    public static final EngineeringUnits centimetersOfMercury = new EngineeringUnits(
            60);

    public static final EngineeringUnits inchesOfMercury = new EngineeringUnits(
            61);

    // Temperature
    public static final EngineeringUnits degreesCelsius = new EngineeringUnits(
            62);

    public static final EngineeringUnits degreesKelvin = new EngineeringUnits(
            63);

    public static final EngineeringUnits degreesKelvinPerHour = new EngineeringUnits(
            181);

    public static final EngineeringUnits degreesKelvinPerMinute = new EngineeringUnits(
            182);

    public static final EngineeringUnits degreesFahrenheit = new EngineeringUnits(
            64);

    public static final EngineeringUnits degreeDaysCelsius = new EngineeringUnits(
            65);

    public static final EngineeringUnits degreeDaysFahrenheit = new EngineeringUnits(
            66);

    public static final EngineeringUnits deltaDegreesFahrenheit = new EngineeringUnits(
            120);

    public static final EngineeringUnits deltaDegreesKelvin = new EngineeringUnits(
            121);
    ...
    public static final EngineeringUnits hundredthsSeconds = new EngineeringUnits(
            158);

    public static final EngineeringUnits milliseconds = new EngineeringUnits(
            159);

    // Torque
    public static final EngineeringUnits newtonMeters = new EngineeringUnits(
            160);

    // Velocity
    public static final EngineeringUnits millimetersPerSecond = new EngineeringUnits(
            161);

    public static final EngineeringUnits millimetersPerMinute = new EngineeringUnits(
            162);

    public static final EngineeringUnits metersPerSecond = new EngineeringUnits(
            74);

    public static final EngineeringUnits metersPerMinute = new EngineeringUnits(
            163);

    public static final EngineeringUnits metersPerHour = new EngineeringUnits(
            164);

    public static final EngineeringUnits kilometersPerHour = new EngineeringUnits(
            75);

    public static final EngineeringUnits feetPerSecond = new EngineeringUnits(
            76);

    public static final EngineeringUnits feetPerMinute = new EngineeringUnits(
            77);

    public static final EngineeringUnits milesPerHour = new EngineeringUnits(
            78);
    ...
    public static final EngineeringUnits imperialGallons = new EngineeringUnits(
            81);
    ...
    // Volumetric Flow
    public static final EngineeringUnits cubicFeetPerSecond = new EngineeringUnits(
            142);

    public static final EngineeringUnits cubicFeetPerMinute = new EngineeringUnits(
            84);

    public static final EngineeringUnits cubicMetersPerSecond = new EngineeringUnits(
            85);

    public static final EngineeringUnits cubicMetersPerMinute = new EngineeringUnits(
            165);

    public static final EngineeringUnits cubicMetersPerHour = new EngineeringUnits(
            135);

    public static final EngineeringUnits imperialGallonsPerMinute = new EngineeringUnits(
            86);

    public static final EngineeringUnits litersPerSecond = new EngineeringUnits(
            87);

    public static final EngineeringUnits litersPerMinute = new EngineeringUnits(
            88);

    public static final EngineeringUnits litersPerHour = new EngineeringUnits(
            136);

    public static final EngineeringUnits usGallonsPerMinute = new EngineeringUnits(
            89);

    // Other
    public static final EngineeringUnits degreesAngular = new EngineeringUnits(
            90);

    public static final EngineeringUnits degreesCelsiusPerHour = new EngineeringUnits(
            91);

    public static final EngineeringUnits degreesCelsiusPerMinute = new EngineeringUnits(
            92);

    public static final EngineeringUnits degreesFahrenheitPerHour = new EngineeringUnits(
            93);

    public static final EngineeringUnits degreesFahrenheitPerMinute = new EngineeringUnits(
            94);

    public static final EngineeringUnits jouleSeconds = new EngineeringUnits(
            183);

    public static final EngineeringUnits kilogramsPerCubicMeter = new EngineeringUnits(
            186);

    public static final EngineeringUnits kilowattHoursPerSquareMeter = new EngineeringUnits(
            137);

    public static final EngineeringUnits kilowattHoursPerSquareFoot = new EngineeringUnits(
            138);

    public static final EngineeringUnits megajoulesPerSquareMeter = new EngineeringUnits(
            139);

    public static final EngineeringUnits megajoulesPerSquareFoot = new EngineeringUnits(
            140);

    public static final EngineeringUnits noUnits = new EngineeringUnits(95);

    public static final EngineeringUnits newtonSeconds = new EngineeringUnits(
            187);

    public static final EngineeringUnits newtonsPerMeter = new EngineeringUnits(
            188);

    public static final EngineeringUnits partsPerMillion = new EngineeringUnits(
            96);

    public static final EngineeringUnits partsPerBillion = new EngineeringUnits(
            97);

    public static final EngineeringUnits percent = new EngineeringUnits(98);

    public static final EngineeringUnits percentObscurationPerFoot = new EngineeringUnits(
            143);

    public static final EngineeringUnits percentObscurationPerMeter = new EngineeringUnits(
            144);

    public static final EngineeringUnits percentPerSecond = new EngineeringUnits(
            99);
    ...
    public static final EngineeringUnits psiPerDegreeFahrenheit = new EngineeringUnits(
            102);

    public static final EngineeringUnits radians = new EngineeringUnits(103);

    public static final EngineeringUnits radiansPerSecond = new EngineeringUnits(
            184);

    public static final EngineeringUnits revolutionsPerMinute = new EngineeringUnits(
            104);

    public static final EngineeringUnits squareMetersPerNewton = new EngineeringUnits(
            185);

    public static final EngineeringUnits wattsPerMeterPerDegreeKelvin = new EngineeringUnits(
            189);

    public static final EngineeringUnits wattsPerSquareMeterDegreeKelvin = new EngineeringUnits(
            141);

    public static final EngineeringUnits[] ALL = { squareMeters, squareFeet,
            milliamperes, amperes, ohms, volts, kilovolts, megavolts,
            voltAmperes, kilovoltAmperes, megavoltAmperes, voltAmperesReactive,
            kilovoltAmperesReactive, megavoltAmperesReactive, degreesPhase,
            powerFactor, joules, kilojoules, wattHours, kilowattHours, btus,
            therms, tonHours, joulesPerKilogramDryAir, btusPerPoundDryAir,
            cyclesPerHour, cyclesPerMinute, hertz,
            gramsOfWaterPerKilogramDryAir, percentRelativeHumidity, millimeters,
            meters, inches, feet, wattsPerSquareFoot, wattsPerSquareMeter,
            lumens, luxes, footCandles, kilograms, poundsMass, tons,
            kilogramsPerSecond, kilogramsPerMinute, kilogramsPerHour,
            poundsMassPerMinute, poundsMassPerHour, watts, kilowatts, megawatts,
            btusPerHour, horsepower, tonsRefrigeration, pascals, kilopascals,
            bars, poundsForcePerSquareInch, centimetersOfWater, inchesOfWater,
            millimetersOfMercury, centimetersOfMercury, inchesOfMercury,
            degreesCelsius, degreesKelvin, degreesFahrenheit, degreeDaysCelsius,
            degreeDaysFahrenheit, years, months, weeks, days, hours, minutes,
            seconds, metersPerSecond, kilometersPerHour, feetPerSecond,
            feetPerMinute, milesPerHour, cubicFeet, cubicMeters,
            imperialGallons, liters, usGallons, cubicFeetPerMinute,
            cubicMetersPerSecond, imperialGallonsPerMinute, litersPerSecond,
            litersPerMinute, usGallonsPerMinute, degreesAngular,
            degreesCelsiusPerHour, degreesCelsiusPerMinute,
            degreesFahrenheitPerHour, degreesFahrenheitPerMinute, noUnits,
            partsPerMillion, partsPerBillion, percent, percentPerSecond,
            perMinute, perSecond, psiPerDegreeFahrenheit, radians,
            revolutionsPerMinute, currency1, currency2, currency3, currency4,
            currency5, currency6, currency7, currency8, currency9, currency10,
            squareInches, squareCentimeters, btusPerPound, centimeters,
            poundsMassPerSecond, deltaDegreesFahrenheit, deltaDegreesKelvin,
            kilohms, megohms, millivolts, kilojoulesPerKilogram, megajoules,
            joulesPerDegreeKelvin, joulesPerKilogramDegreeKelvin, kilohertz,
            megahertz, perHour, milliwatts, hectopascals, millibars,
            cubicMetersPerHour, litersPerHour, kilowattHoursPerSquareMeter,
            kilowattHoursPerSquareFoot, megajoulesPerSquareMeter,
            megajoulesPerSquareFoot, wattsPerSquareMeterDegreeKelvin,
            cubicFeetPerSecond, percentObscurationPerFoot,
            percentObscurationPerMeter, milliohms, megawattHours, kiloBtus,
            megaBtus, kilojoulesPerKilogramDryAir, megajoulesPerKilogramDryAir,
            kilojoulesPerDegreeKelvin, megajoulesPerDegreeKelvin, newton,
            gramsPerSecond, gramsPerMinute, tonsPerHour, kiloBtusPerHour,
            hundredthsSeconds, milliseconds, newtonMeters, millimetersPerSecond,
            millimetersPerMinute, metersPerMinute, metersPerHour,
            cubicMetersPerMinute, metersPerSecondPerSecond, amperesPerMeter,
            amperesPerSquareMeter, ampereSquareMeters, farads, henrys,
            ohmMeters, siemens, siemensPerMeter, teslas, voltsPerDegreeKelvin,
            voltsPerMeter, webers, candelas, candelasPerSquareMeter,
            degreesKelvinPerHour, degreesKelvinPerMinute, jouleSeconds,
            radiansPerSecond, squareMetersPerNewton, kilogramsPerCubicMeter,
            newtonSeconds, newtonsPerMeter, wattsPerMeterPerDegreeKelvin, };

    public EngineeringUnits(final int value) {
        super(value);
    }

    public EngineeringUnits(final ByteQueue queue) {
        super(queue);
    }
