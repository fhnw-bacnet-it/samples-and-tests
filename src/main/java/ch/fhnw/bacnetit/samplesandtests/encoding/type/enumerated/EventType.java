...
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.BufferReady;
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.ChangeOfBitString;
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.ChangeOfLifeSafety;
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.ChangeOfState;
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.ChangeOfValue;
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.CommandFailure;
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.Extended;
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.FloatingLimit;
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.OutOfRange;
import ch.fhnw.bacnetit.samplesandtests.encoding.type.eventParameter.UnsignedRange;
