...
public class ErrorCode extends Enumerated {
    ...
    public static final ErrorCode dynamicCreationNotSupported = new ErrorCode(
            4);
    ...
    public static final ErrorCode inconsistentSelectionCriterion = new ErrorCode(
            8);
    ...
    public static final ErrorCode objectDeletionNotPermitted = new ErrorCode(
            23);

    public static final ErrorCode objectIdentifierAlreadyExists = new ErrorCode(
            24);
    ...
    public static final ErrorCode vtSessionTerminationFailure = new ErrorCode(
            39);
    ...
    public static final ErrorCode optionalFunctionalityNotSupported = new ErrorCode(
            45);
    ...
    public static final ErrorCode abortInvalidApduInThisState = new ErrorCode(
            52);

    public static final ErrorCode abortPreemptedByHigherPriorityTask = new ErrorCode(
            53);

    public static final ErrorCode abortSegmentationNotSupported = new ErrorCode(
            54);
    ...
    public static final ErrorCode rejectInconsistentParameters = new ErrorCode(
            60);

    public static final ErrorCode rejectInvalidParameterDataType = new ErrorCode(
            61);

    public static final ErrorCode rejectInvalidTag = new ErrorCode(62);

    public static final ErrorCode rejectMissingRequiredParameter = new ErrorCode(
            63);
    ...
    public static final ErrorCode rejectUndefinedEnumeration = new ErrorCode(
            66);
    ...
    public static final ErrorCode notConfiguredForTriggeredLogging = new ErrorCode(
            78);
    ...
    public static final ErrorCode[] ALL = { other, authenticationFailed,
            configurationInProgress, deviceBusy, dynamicCreationNotSupported,
            fileAccessDenied, incompatibleSecurityLevels,
            inconsistentParameters, inconsistentSelectionCriterion,
            invalidDataType, invalidFileAccessMethod, invalidFileStartPosition,
            invalidOperatorName, invalidParameterDataType, invalidTimeStamp,
            keyGenerationError, missingRequiredParameter,
            noObjectsOfSpecifiedType, noSpaceForObject, noSpaceToAddListElement,
            noSpaceToWriteProperty, noVtSessionsAvailable, propertyIsNotAList,
            objectDeletionNotPermitted, objectIdentifierAlreadyExists,
            operationalProblem, passwordFailure, readAccessDenied,
            securityNotSupported, serviceRequestDenied, timeout, unknownObject,
            unknownProperty, unknownVtClass, unknownVtSession,
            unsupportedObjectType, valueOutOfRange, vtSessionAlreadyClosed,
            vtSessionTerminationFailure, writeAccessDenied,
            characterSetNotSupported, invalidArrayIndex, covSubscriptionFailed,
            notCovProperty, optionalFunctionalityNotSupported,
            invalidConfigurationData, datatypeNotSupported, duplicateName,
            duplicateObjectId, propertyIsNotAnArray, abortBufferOverflow,
            abortInvalidApduInThisState, abortPreemptedByHigherPriorityTask,
            abortSegmentationNotSupported, abortProprietary, abortOther,
            invalidTag, networkDown, rejectBufferOverflow,
            rejectInconsistentParameters, rejectInvalidParameterDataType,
            rejectInvalidTag, rejectMissingRequiredParameter,
            rejectParameterOutOfRange, rejectTooManyArguments,
            rejectUndefinedEnumeration, rejectUnrecognizedService,
            rejectProprietary, rejectOther, unknownDevice, unknownRoute,
            valueNotInitialized, invalidEventState, noAlarmConfigured,
            logBufferFull, loggedValuePurged, noPropertySpecified,
            notConfiguredForTriggeredLogging, communicationDisabled,
            unknownFileSize, };
