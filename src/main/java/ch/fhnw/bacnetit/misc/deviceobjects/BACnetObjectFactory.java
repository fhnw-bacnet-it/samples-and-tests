...
import ch.fhnw.bacnetit.misc.encoding.exception.BACnetServiceException;
import ch.fhnw.bacnetit.misc.encoding.type.AmbiguousValue;
import ch.fhnw.bacnetit.misc.encoding.type.Encodable;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.AccumulatorRecord;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.ActionList;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.AddressBinding;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.CalendarEntry;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.ClientCov;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.CovSubscription;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.DailySchedule;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.DateRange;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.DateTime;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.Destination;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.DeviceObjectPropertyReference;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.DeviceObjectReference;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.EventLogRecord;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.EventTransitionBits;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.LimitEnable;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.LogMultipleRecord;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.LogRecord;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.ObjectPropertyReference;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.ObjectTypesSupported;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.Prescale;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.PriorityArray;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.ReadAccessResult;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.ReadAccessSpecification;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.Recipient;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.Scale;
...
import ch.fhnw.bacnetit.misc.encoding.type.constructed.SessionKey;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.SetpointReference;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.ShedLevel;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.SpecialEvent;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.StatusFlags;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.TimeStamp;
import ch.fhnw.bacnetit.misc.encoding.type.constructed.VtSession;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.Action;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.BackupState;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.BinaryPV;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.DeviceStatus;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.DoorAlarmState;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.DoorSecuredStatus;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.DoorStatus;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.DoorValue;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.EngineeringUnits;
...
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.FileAccessMethod;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.LifeSafetyMode;
...
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.LockStatus;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.LoggingType;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.Maintenance;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.NodeType;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.NotifyType;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.Polarity;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.ProgramError;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.ProgramRequest;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.ProgramState;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.Reliability;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.RestartReason;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.Segmentation;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.ShedState;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.SilencedState;
import ch.fhnw.bacnetit.misc.encoding.type.enumerated.VtClass;
