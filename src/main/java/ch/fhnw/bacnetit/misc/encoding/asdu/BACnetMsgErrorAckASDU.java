 ...
 *******************************************************************************/
package ch.fhnw.bacnetit.misc.encoding.asdu;

import ch.fhnw.bacnetit.misc.encoding.exception.BACnetException;
import ch.fhnw.bacnetit.misc.encoding.type.error.BaseError;
 ...
 */
public class BACnetMsgErrorAckASDU extends AckASDU {
    /**
    ...
    public BACnetMsgErrorAckASDU(final ByteQueue queue) throws BACnetException {
    ...
    public boolean equals(final Object obj) {
        ...
        final BACnetMsgErrorAckASDU other = (BACnetMsgErrorAckASDU) obj;
        if (error == null) {
            if (other.error != null) {
                return false;
            }
